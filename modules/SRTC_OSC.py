...
class SRTC_OSC:
  def __init__(self, settings: dict, log: callable):
    ...
    self._OSC_Client: udp_client.SimpleUDPClient = udp_client.SimpleUDPClient(self._OSC_Send_IP, self._OSC_Send_Port)
  ...
  def start_server(self):
    self._OSC_Server: osc_server.ThreadingOSCUDPServer = osc_server.ThreadingOSCUDPServer((self._OSC_Recv_IP, self._OSC_Recv_Port), self._disp)
